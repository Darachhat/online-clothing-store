      ...
      {/* ---------- Product Data -------- */}
        ...
        <div className='mt-20'>
          ...
          <div className='flex flex-col gap-4 border px-6 text-sm text-gray-500'>
            <p>Welcome to TOS, your ultimate fashion destination for stylish and affordable clothing. We offer a curated selection of high-quality, trendy apparel for men, women, and children. From casual wear to formal attire, our collection is designed to suit every style and occasion. </p>
