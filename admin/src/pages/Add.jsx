...
const Add = ({token}) => {
  ...
  return (
    ...
    <div className='w-full'>
      ...
      <textarea className='w-full max-w-[500px] px-3 py-2'
    ...
    <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input className='w-full px-3 py-2 sm:w-[120px]'
    ...
    <div>
      ...
      <div className='flex gap-3'>
        <div onClick={(e)=>setSizes(prev => prev.includes("S") ? prev.filter(item => item !== "S") : [...prev,"S"])} >
          <p className={`${sizes.includes("S") ? "bg-pink-100" : "bg-pink-300"} px-3 py-1 cursor-pointer`}>S</p>
        </div>

        <div onClick={(e)=>setSizes(prev => prev.includes("M") ? prev.filter(item => item !== "M") : [...prev,"M"])} >
          <p className={`${sizes.includes("M") ? "bg-pink-100" : "bg-pink-300"} px-3 py-1 cursor-pointer`}>M</p>
        </div>

        <div onClick={(e)=>setSizes(prev => prev.includes("L") ? prev.filter(item => item !== "L") : [...prev,"L"])} >
          <p className={`${sizes.includes("L") ? "bg-pink-100" : "bg-pink-300"} px-3 py-1 cursor-pointer`}>L</p>
        </div>

        <div onClick={(e)=>setSizes(prev => prev.includes("XL") ? prev.filter(item => item !== "XL") : [...prev,"XL"])} >
          <p className={`${sizes.includes("XL") ? "bg-pink-100" : "bg-pink-300"} px-3 py-1 cursor-pointer`}>Xl</p>
        </div>

        <div onClick={(e)=>setSizes(prev => prev.includes("XXL") ? prev.filter(item => item !== "XXL") : [...prev,"XXL"])} >
          <p className={`${sizes.includes("XXL") ? "bg-pink-100" : "bg-pink-300"} px-3 py-1 cursor-pointer`}>XXL</p>
        </div>
      </div>
    </div>
